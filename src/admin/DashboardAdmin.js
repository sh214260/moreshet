import { AppBar, Avatar, Box, Grid, IconButton, Link, Paper, Toolbar, Typography, createTheme } from "@mui/material";
        ...
        <Grid container>
            ...
            backgroundColor: "white",alignItems:"center", justifyContent:"space-between", boxShadow:"none" }} >
                ...
                <Box display="flex" flexDirection="column" paddingRight={1} sx={{marginLeft:4}}>
                    <Typography style={{ color: "black" }}>{ctx.user.name}</Typography>
                    <Typography style={{ color: "gray" }}>{ctx.user.email}</Typography>
                </Box>
                </div>
            </AppBar>
